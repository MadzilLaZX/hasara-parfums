...
export const fragrances: Fragrance[] = [
  {
    ...
    collection: "mens",
    collectionLabel: "Collection For Him",
    sizes: SIZES,
    description:
    ...
    mainAccords: ["Warm Spicy", "Sweet", "Tobacco", "Vanilla"],
    season: ["Fall", "Winter"],
    dayNight: "Night",
  ...
  },
  {
    ...
    mainAccords: ["Aquatic", "Aromatic", "Fresh", "Woody"],
    season: ["Spring", "Summer"],
    dayNight: "Day",
    longevity: "8 - 10 Hours",
    occasion: "Evening, Casual, Travel",
    gender: "Men",
    inspiredBy: "Armani Acqua Di Gio Profondo",
    featured: true,
    bestseller: false,
  },
  {
    ...
    mainAccords: ["Warm Spicy", "Sweet", "Aromatic", "Vanilla"],
    season: ["Fall", "Winter"],
    dayNight: "Day & Night",
    longevity: "12+ Hours",
  ...
  },
  {
    ...
    name: "Sensual Mirage",
    collection: "womens",
    collectionLabel: "Collection For Her",
    sizes: SIZES,
    description:
    ...
    mainAccords: ["Powdery", "Floral", "Sweet", "Vanilla"],
    season: ["Fall", "Winter", "Spring"],
    dayNight: "Day & Night",
    longevity: "10 - 12 Hours",
    occasion: "Evening, Romantic, Date night",
    gender: "Women",
    inspiredBy: "JPG Divine",
    featured: true,
    bestseller: false,
  },
  {
    ...
    mainAccords: ["Fresh Fruity", "Floral", "Sweet", "Musk"],
    season: ["Spring", "Summer"],
    dayNight: "Day & Night",
    longevity: "8 - 10 Hours",
    occasion: "Day, Evening, Celebrations",
    gender: "Women",
    inspiredBy: "Cherry Kiss",
    featured: false,
    bestseller: false,
  },
  {
    ...
    mainAccords: ["Fresh", "Woody", "Aromatic", "Citrus"],
  ...
  },
  {
    ...
    mainAccords: ["Fresh", "Aromatic", "Citrus", "Woody"],
    season: ["Spring", "Summer"],
    dayNight: "Day",
    longevity: "6 - 8 Hours",
  ...
  },
  {
    ...
    mainAccords: ["Floral", "Fresh", "Fruity", "Powdery"],
    season: ["Spring", "Summer", "Fall"],
    dayNight: "Day",
    longevity: "8 - 10 Hours",
  ...
  },
  {
    ...
    mainAccords: ["Fresh Spicy", "Sweet", "Aromatic", "Woody"],
    season: ["Spring", "Summer", "Fall"],
    dayNight: "Day & Night",
    longevity: "10 - 12 Hours",
  ...
  },
  {
    ...
    name: "Dawn Fever",
    collection: "unisex",
    collectionLabel: "Collection For All",
    sizes: SIZES,
    description:
    ...
    mainAccords: ["Floral", "Amber", "Musk", "Sweet"],
  ...
  },
  {
    ...
    mainAccords: ["Fresh Fruity", "Floral", "Musk", "Sweet"],
    season: ["Spring", "Summer"],
    dayNight: "Day",
    longevity: "6 - 8 Hours",
...
export const collections = [
  {
    id: "mens",
    label: "For Him",
    description: "Bold, commanding parfums for the modern man.",
